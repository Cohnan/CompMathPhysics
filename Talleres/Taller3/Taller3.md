...
ls "$carpetaProgs" | head -30 | while read prog ; do gcc -s -o $carpetaProgs$prog.out $carpetaProgs$prog ; grep -A 1 "Example" $carpetaProgs$prog ; $carpetaProgs$prog.out ; echo -e "\n\n" ; done
```
